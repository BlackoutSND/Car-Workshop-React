...
import './UserDelete.css'; // You can use this to style your component similarly to your original CSS
        ...
        <div className="container mt-4 mb-4 p-3 d-flex justify-content-center">
            <div className="card p-4">
                <div className="image d-flex flex-column justify-content-center align-items-center">
                    ...
                    >
                        <img
                            src={user.image ? user.image : '/Resources/Placeholders/UserPicturePlaceholder.png'}
                            height="100"
                            width="100"
                            alt="User"
                        />
